...
const outerOrigin = "https://search.example.com";
...
/**
 * 替换上游响应体中的特定字符
 * @param {string} respsonseText 响应体文本
 * @returns {string}
 */
...
export default {
  async fetch(request, env) {
    /** 访问本地文件 */
    const findLocalFileByPath = (pathname, replacer) => fetchLocal(env.files, "google-search", pathname.slice(1), replacer);
